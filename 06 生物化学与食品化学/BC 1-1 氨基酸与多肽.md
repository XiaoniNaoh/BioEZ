...
summary: "介绍《生物化学与食品化学 考研帮帮忙》中的“氨基酸与多肽”主题。"
references: []
content_type: "lesson"
---
...
> [!NOTE] 课程导航
> [课程目录](<COURSE_INDEX.md>) · [下一篇：蛋白质的结构 →](<BC 1-2 蛋白质的结构.md>)
...
- R 基团的性质决定了氨基酸的理化特性。
![α-氨基酸通式：中心碳连接氨基、羧基、氢和 R 基](../assets/generated/amino-acid-structure.svg)
